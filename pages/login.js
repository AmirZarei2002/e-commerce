...
import { logIn, useSession } from 'next-auth/react';
        ...
        <div className="md:flex w-full">
          ...
          <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
            <div className="text-center mb-10">
              <h1 className="font-bold text-3xl light-slate">Login</h1>
              <p className="light-slate">Enter your information to Login</p>
            </div>
            <div className="flex -mx-3">
              <div className="w-full px-3 mb-5">
                ...
                <div className="flex flex-col pl-10 lg:px-10">
                  ...
                  <input
                    ...
                    className="w-full -ml-10 md:pl-5 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:light-slate"
                    placeholder="amir.zarei@example.com"
                    autoFocus
                  />
                  {errors.email && (
            ...
            <div className="flex flex-col space-y-2 md:space-y-4 justify-center text-center -mx-3">
              <div className="w-full flex justify-around lg:justify-start lg:gap-10 text-left items-center self-center px-3 mb-5">
                <button className="w-full px-4 py-2 mr-6 md:mr-2 truncate lg:py-3 flex items-center justify-center gap-1 bg-gradient-to-r from-yellow-500 via-red-400 to-slate-500 text-white/90 font-semibold rounded-xl hover:-translate-y-1 duration-300">
                  <Link href="login">Login</Link>
                  <FiLogIn className="text-lg" />
                </button>
              </div>
              <div className="w-full flex justify-around lg:justify-between text-left items-center px-3 mb-5">
                Don&apos;t have an account? &nbsp;
                <button className="w-fit px-4 py-2 mr-6 md:mr-2 truncate lg:py-3 flex items-center justify-center gap-1 bg-gradient-to-r from-yellow-500 via-red-400 to-slate-500 text-white/90 font-semibold rounded-xl hover:-translate-y-1 duration-300">
                  <Link href="/register">Register</Link>
                  <GoSignIn className="hidden sm:flex text-lg" />
                </button>
              </div>
            </div>
          </div>
