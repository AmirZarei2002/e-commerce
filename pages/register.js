        ...
        <div className="md:flex w-full">
          ...
          <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
            <div className="text-center mb-10">
              <h1 className="font-bold text-3xl light-slate">REGISTER</h1>
              <p className='light-slate'>Enter your information to register</p>
            </div>
            <div>
              <div className="flex -mx-3">
                <div className="w-1/2 px-3 mb-5">
                  ...
                  <div className="flex">
                    ...
                    <input
                      type="text"
                      className="w-full -ml-10 pl-5 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:light-slate"
                      placeholder="amir"
                    />
                  </div>
                </div>
              ...
              <div className="flex justify-center text-center  -mx-3">
                <div className="w-full flex justify-center text-center items-center self-center px-3 mb-5">
